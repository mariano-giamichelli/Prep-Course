...
function esPrimo(numero) {
  ...
  for (var i=2; i<numero; i++)
      {
        if (numero % i === 0) return false  // Nota: esta funcion si se cumple ya deja de ser primo y en caso de no cumplirse se hara el for hasta que culmine su iteracion
      } 
  return true
}
